...
from detector.yolov5.utils.general import check_img_size, non_max_suppression
from detector.yolov5.utils.general import bbox_iou
from detector.yolov5.utils.preprocess import prep_image, prep_frame
from detector.yolov5.utils.util import unique
            ...
            for cls in img_classes:
                ...
                if nms:
                    if platform.system() != 'Windows':
                        ...
                        image_pred_class = torch.cat((max_detections[0],max_detections[1].squeeze(0))).data
