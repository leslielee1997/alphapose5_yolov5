...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from detector.yolov5.models.common import AutoShape, DetectMultiBackend
    from detector.yolov5.models.yolo import Model
    from detector.yolov5.utils.downloads import attempt_download
    from detector.yolov5.utils.general import LOGGER, check_requirements, intersect_dicts, logging
